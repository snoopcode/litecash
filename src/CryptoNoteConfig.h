...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xd7; // starts with "c"
...
const int      P2P_DEFAULT_PORT                              = 5050;
const int      RPC_DEFAULT_PORT                              = 5051;
...
const std::initializer_list<CheckpointData> CHECKPOINTS = {
  { 1200, "441081332da218172cd9aa5304eb9c5c6125d9aa4db4ba82e67a5c31df28a746" },
};
